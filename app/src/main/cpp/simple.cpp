...
#include "include/witnesscalc_IdentityAuth.h"
...
Java_com_example_simplewallet_ZKPUtil_groth16InternalStorage(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_simplewallet_ZKPUtil_groth16ProverBig(JNIEnv *env, jobject thiz,
                                                       jstring filename,
                                                       jbyteArray wtns_buffer,
                                                       jlong wtns_size,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_simplewallet_ZKPUtil_auth(JNIEnv *env, jobject thiz, jbyteArray circuit_buffer,
    ...
    int result = witnesscalc_IdentityAuth(
